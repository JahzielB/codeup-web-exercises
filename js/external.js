...
var littleMermaid = parseInt(prompt("How many days will The little Mermaid be rented?"));
var brotherBear = parseInt(prompt("How many days will Brother Bear be rented?"));
var hercules = parseInt(prompt("How many days will Hercules be rented?"));
var moviePricePerDay = parseInt(prompt("What is the daily rental rate for movies today?"));
...
var googlePay = parseInt(prompt("How much is Google paying you by the hour?"));
var amazonPay = parseInt(prompt("How much is Amazon paying you by the hour?"));
var facebookPay = parseInt(prompt("How much is Facebook paying you by the hour?"));
